            ...
            {requests?.map(item => (
                ...
                <div className="card-body p-4">
                    ...
                    <div className="card-actions justify-between"  >
                        <button  className="btn btn-circle bg-blue-400" title="Reject" onClick={()=>rejectRequest(item._id)}>
                        ...
                        <button className="btn btn-circle bg-red-400" title="Accept" onClick={()=>acceptRequest(item._id)}>
